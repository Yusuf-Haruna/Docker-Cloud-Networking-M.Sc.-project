...
dd if=/dev/urandom of=host_one_MB_index.html count=1024 bs=1024  # create 1MB html file
dd if=/dev/urandom of=host_one_KB_index.html count=4 bs=256  # create 1KB html file
cd /
service nginx start
